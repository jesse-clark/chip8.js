...
var chip8 = new function() {
    ...
    this.loadGame = function() {
        for( var i = 0; i < tetris.length; i += 1 ) {
            this.memory[i + 512] = tetris[i];
        }
    }
    ...
    this.setKeys = function () {
       ...
       // this.status_box(this.key + "\n");
       // for( var i = 0; i < 16; i+=1)
       //     this.key[i] = 0;
       // for( k in Key._pressed) {
       //     this.status_box( ' ' + k + ' is val' + Key.isVal(k));
       // }
       // this.status_box("\n");
    }
...
var start = function () {
    ...
    //    chip8.setKeys();
    //}
    setInterval(function(){emu_cycle(chip8)}, 1000 / 1000);
    setInterval(function(){chip8.decrement_timers()}, 1000 / 60);
}
